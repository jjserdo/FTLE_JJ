...
# ╔═╡ 44d4dbc1-af57-40f2-9565-d8c728859b32
using PyPlot, PlutoUI

# ╔═╡ 61e82cb5-b3e8-4892-b3a7-55c654b35c27
using FileIO, ImageMagick, Colors, FixedPointNumbers, DelimitedFiles, LinearAlgebra, HDF5

# ╔═╡ 1547cf15-94b0-48c5-aa73-ae8e3b918740
function set_grid()
	global overall_path
    # Read grid files
...
# ╔═╡ c22282fc-5f18-472d-844a-bd9db9fe37db
...
# ╔═╡ 27a9a927-7ddc-48cf-84e1-183c8718a8ba
begin
	VRcomp = "C:/Users/GreenFluids_VR/Downloads/2D_PIV_pitching_foil_YZ"
	HPcomp = "C:/Users/justi/OneDrive - Syracuse University/Documents/2D_PIV_pitching_foil_YZ"
end

# ╔═╡ 6257a88d-acfb-43d7-98f9-8c430acc662f
@bind com Select(["VR","HP"])

# ╔═╡ 0cdf8990-98dd-41e6-be4b-865be99e2cd3
begin
	if com == "VR"
		comp = VRcomp
	elseif com == "HP"
...
# ╔═╡ bb7f3df0-9930-41af-a9e6-a624596b413c
md"""
Running from 
"""

# ╔═╡ c23ead7c-9c45-4a69-96b4-efc8a1c63232
@bind x Slider(5:15)

# ╔═╡ 10006a7d-6f1a-49ff-88f3-c34d005d5b86
x
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "4c7531fb576204de446d38b5af79a62cbc25f757"
